    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProfilePatientActivity.this, "Details updated!", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(ProfilePatientActivity.this, HomeClinicActivity.class));
                finish();
